...
/**
 * Generated class for the CustomerBalanceMainPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-customer-balance-main',
  templateUrl: 'customer-balance-main.html',
})
export class CustomerBalanceMainPage {
...
loader.present();
  ...
  confirmDeposit(customer: any) {
    let alert = this.alertCtrl.create({
      ...
      message: 'Do you want check balances for ' + customer.customerName+"?",
      buttons: [
      
        {
          text: 'Yes',
          handler: () => {
            this.navCtrl.push('BalacesPage', { customer: customer });
          }
        },
        {
          text: 'No',
